defmodule BywaterWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BywaterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BywaterWeb.Gettext, "errors", msg, opts)
    end
  end
